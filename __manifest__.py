...
#############################################################################
{
    ...
    'assets': {
        'web.assets_frontend': [
            '/theme_arc/static/src/xml/blog_snippet_templates.xml',
            '/theme_arc/static/src/xml/testimonial_snippet_templates.xml',
            '/theme_arc/static/src/js/service_products.js',
            '/theme_arc/static/src/js/car_garage.js',
            'theme_arc/static/src/css/style.css',
            '/theme_arc/static/src/js/owl.carousel.js',
            '/theme_arc/static/src/js/owl.carousel.min.js',
            'theme_arc/static/src/css/owl.theme.default.min.css',
            '/theme_arc/static/src/js/owl.carousel.js',
            '/theme_arc/static/src/js/product_tab.js',
            '/theme_arc/static/src/js/find_car.js',
            '/theme_arc/static/src/js/search.js',
            '/theme_arc/static/src/js/blog.js',
            '/theme_arc/static/src/js/testimonial.js',
            '/theme_arc/static/src/js/all_type.js',
        ],
    },
    'images': [
